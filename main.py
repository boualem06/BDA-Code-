...
# url = up.urlparse(f"postgres://{pg_user}:{pg_password}@{pg_host}:{pg_port}/{pg_database}")
...
#     # Call the stored procedure to insert a new row
#     name = "boualem"
#     age = 100

#     # Use the CALL statement to execute the stored procedure
#     cursor.execute("CALL insert_person(%s, %s)", (name, age))

#     # Commit the transaction
#     conn.commit()

#     print(f"Row inserted successfully: ({name}, {age})")
